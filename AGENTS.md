# AI Agent Reference for ha-norma
...
| Area | Path |
|---|---|
| Integration Entry | `custom_components/norma/__init__.py` |
| Coordinator | `custom_components/norma/coordinator.py` |
| API Client | `custom_components/norma/api.py` |
| Config Flow | `custom_components/norma/config_flow.py` |
| Sensor platform | `custom_components/norma/sensor.py` |
| Binary Sensor platform | `custom_components/norma/binary_sensor.py` |
| Button platform | `custom_components/norma/button.py` |
| Diagnostics | `custom_components/norma/diagnostics.py` |
...
- **Anti-Ban Guards**: Always utilize domain-wide locks, jitter, backoff, and local storage caching when communicating with external APIs.
